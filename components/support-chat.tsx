...
const botResponses: Record<string, string> = {
  ...
  "📞 Позвонить": "Наш телефон: +7 (950) 562-39-31. Работаем с 10:00 до 22:00 ежедневно.",
}
...
function generateResponse(input: string): string {
  ...
  if (lower.includes("телефон") || lower.includes("позвонит") || lower.includes("связат")) {
    return "Наш телефон: +7 (950) 562-39-31. Звоните с 10:00 до 22:00! 📞"
  }
  ...
  return "Спасибо за вопрос! Я пока могу отвечать только на типовые вопросы. Для сложного вопроса позвоните нам: +7 (950) 562-39-31 или напишите на info@quikmaki.ru 📧"
}
